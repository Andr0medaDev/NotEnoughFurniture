...
public class ModSounds {
    ...
    public static final Supplier<SoundEvent> DRAWER_OPEN = registerSoundEvent("drawer_open");
    public static final Supplier<SoundEvent> DRAWER_CLOSE = registerSoundEvent("drawer_close");
